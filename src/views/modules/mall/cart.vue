  ...
  <div class="mod-cart">
    <el-form :inline="true" :model="searchForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('mall:cart:delete')" type="danger" @click="deleteHandle()"
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button v-if="isAuth('mall:cart:info')" type="text" size="small"
                     @click="showDetails(scope.row.id, scope.row.shopsName)">查看
          </el-button>
