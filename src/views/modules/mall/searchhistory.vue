<template>
  <div class="mod-searchhistory">
    <el-form :inline="true" :model="searchForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model="searchForm.nickname" placeholder="参数名" clearable></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="搜索来源">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.searchFrom === 0" size="small" type="success">小程序</el-tag>
          <el-tag v-else-if="scope.row.searchFrom === 1" size="small" type="danger">公众号</el-tag>
          <el-tag v-else-if="scope.row.searchFrom === 2" size="small">APP</el-tag>
          <el-tag v-else-if="scope.row.searchFrom === 3" size="small" type="info">PC</el-tag>
        </template>
      </el-table-column>
      <el-table-column
        prop="addTime"
